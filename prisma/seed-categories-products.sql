...
('var_1', 'prod_1', 'Default', 'GRC-MILK-1', 2.99, 0, true, 100, '["https://images.unsplash.com/photo-1563636619-e9143da7973b?w=400"]'::jsonb, '{"volume":"1L","brand":"Nestlé"}'::jsonb, NOW(), NOW()),
('var_2', 'prod_2', 'Default', 'GRC-YOG-1', 4.49, 0.50, true, 80, '["https://images.unsplash.com/photo-1571212515416-d2b2c462481e?w=400"]'::jsonb, '{"weight":"500g","brand":"Danone"}'::jsonb, NOW(), NOW()),
('var_3', 'prod_3', 'Default', 'GRC-EGG-1', 5.99, 0, true, 120, '["https://images.unsplash.com/photo-1582722872445-44dc5f7e3c8f?w=400"]'::jsonb, '{"quantity":"12 pcs","brand":"Organic Valley"}'::jsonb, NOW(), NOW()),
('var_4', 'prod_4', 'Default', 'GRC-BRD-1', 3.29, 0, true, 60, '["https://images.unsplash.com/photo-1509440159596-0249088772ff?w=400"]'::jsonb, '{"type":"Whole grain","brand":"Nature'"'"'s Own"}'::jsonb, NOW(), NOW()),
('var_5', 'prod_5', 'Default', 'GRC-CRO-1', 4.99, 0, true, 50, '["https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=400"]'::jsonb, '{"pack":"4 pcs","brand":"Brioche Pasquier"}'::jsonb, NOW(), NOW()),
('var_6', 'prod_6', 'Default', 'GRC-SAL-1', 2.49, 0, true, 70, '["https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?w=400"]'::jsonb, '{"weight":"200g","brand":"Fresh Express"}'::jsonb, NOW(), NOW()),
('var_7', 'prod_7', 'Default', 'GRC-ALM-1', 6.99, 1.00, true, 90, '["https://images.unsplash.com/photo-1599599810769-bcde5a160d32?w=400"]'::jsonb, '{"weight":"200g","type":"Roasted","brand":"Blue Diamond"}'::jsonb, NOW(), NOW()),
('var_8', 'prod_8', 'Default', 'GRC-OJ-1', 3.99, 0, true, 85, '["https://images.unsplash.com/photo-1621506289937-a8e4df240d0b?w=400"]'::jsonb, '{"volume":"1L","brand":"Tropicana"}'::jsonb, NOW(), NOW()),
('var_9', 'prod_9', 'Default', 'GRC-OIL-1', 8.99, 0, true, 55, '["https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=400"]'::jsonb, '{"volume":"500ml","type":"Extra virgin","brand":"Bertolli"}'::jsonb, NOW(), NOW()),
('var_10', 'prod_10', 'Default', 'GRC-HON-1', 7.49, 0.50, true, 65, '["https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=400"]'::jsonb, '{"weight":"350g","type":"Organic","brand":"Rowse"}'::jsonb, NOW(), NOW()),
('var_11', 'prod_11', 'Default', 'ELEC-HUB-1', 34.99, 5.00, true, 40, '["https://images.unsplash.com/photo-1625723044792-44de16ccb4e9?w=400"]'::jsonb, '{"color":"Silver","ports":"7-in-1","connectivity":"USB-C","brand":"Anker"}'::jsonb, NOW(), NOW()),
('var_12', 'prod_12', 'Default', 'ELEC-EAR-1', 49.99, 10.00, true, 75, '["https://images.unsplash.com/photo-1590658268037-6bf12165a8df?w=400"]'::jsonb, '{"color":"White","connectivity":"Bluetooth 5.0","brand":"Sony"}'::jsonb, NOW(), NOW()),
('var_13', 'prod_13', 'Default', 'ELEC-STD-1', 12.99, 0, true, 100, '["https://images.unsplash.com/photo-1601784551446-20c9e07cdb31?w=400"]'::jsonb, '{"color":"Silver","material":"Aluminum","brand":"UGREEN"}'::jsonb, NOW(), NOW()),
('var_14', 'prod_14', 'Default', 'FASH-TS-1', 19.99, 3.00, true, 200, '["https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=400"]'::jsonb, '{"color":"Navy","size":"M","material":"Cotton","brand":"Levi'"'"'s"}'::jsonb, NOW(), NOW()),
('var_15', 'prod_15', 'Default', 'FASH-SHO-1', 79.99, 15.00, true, 45, '["https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400"]'::jsonb, '{"color":"White","size":"US 9","brand":"Nike"}'::jsonb, NOW(), NOW()),
('var_16', 'prod_16', 'Default', 'FASH-WAL-1', 29.99, 0, true, 60, '["https://images.unsplash.com/photo-1627123424574-724758594e93?w=400"]'::jsonb, '{"color":"Brown","material":"Leather","brand":"Tommy Hilfiger"}'::jsonb, NOW(), NOW()),
('var_17', 'prod_17', 'Default', 'HOME-VAS-1', 24.99, 4.00, true, 35, '["https://images.unsplash.com/photo-1578500494198-246f612d3b3d?w=400"]'::jsonb, '{"color":"White","set":"2 pcs","material":"Ceramic","brand":"IKEA"}'::jsonb, NOW(), NOW()),
('var_18', 'prod_18', 'Default', 'HOME-CUT-1', 39.99, 0, true, 50, '["https://images.unsplash.com/photo-1584990347492-659b3e529b43?w=400"]'::jsonb, '{"material":"Stainless Steel","pieces":"6","brand":"Tefal"}'::jsonb, NOW(), NOW()),
('var_19', 'prod_19', 'Default', 'HOME-HOS-1', 18.99, 2.00, true, 30, '["https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=400"]'::jsonb, '{"length":"25m","material":"Rubber","brand":"Gardena"}'::jsonb, NOW(), NOW()),
('var_20', 'prod_20', 'Default', 'BEAU-CRM-1', 22.99, 0, true, 80, '["https://images.unsplash.com/photo-1556228720-195a672e8a03?w=400"]'::jsonb, '{"volume":"50ml","skinType":"All","brand":"Nivea"}'::jsonb, NOW(), NOW()),
('var_21', 'prod_21', 'Default', 'BEAU-SHA-1', 14.99, 0, true, 95, '["https://images.unsplash.com/photo-1522338242762-5d67450f1b35?w=400"]'::jsonb, '{"type":"Shampoo + Conditioner","brand":"L'"'"'Oréal"}'::jsonb, NOW(), NOW()),
('var_22', 'prod_22', 'Default', 'SPRT-YOG-1', 26.99, 5.00, true, 70, '["https://images.unsplash.com/photo-1601925260368-ae2f83cf8b7f?w=400"]'::jsonb, '{"thickness":"6mm","material":"TPE","brand":"Decathlon"}'::jsonb, NOW(), NOW()),
('var_23', 'prod_23', 'Default', 'SPRT-FLA-1', 15.99, 0, true, 110, '["https://images.unsplash.com/photo-1510312305653-8ed496ef75e4?w=400"]'::jsonb, '{"type":"LED","waterResistant":"Yes","brand":"Coleman"}'::jsonb, NOW(), NOW()),
('var_24', 'prod_24', 'Default', 'BOOK-NB-1', 9.99, 0, true, 150, '["https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=400"]'::jsonb, '{"size":"A5","pack":"3","ruling":"Ruled","brand":"Moleskine"}'::jsonb, NOW(), NOW()),
('var_25', 'prod_25', 'Default', 'BOOK-PEN-1', 11.99, 1.00, true, 88, '["https://images.unsplash.com/photo-1513542789411-b6a5d4f31634?w=400"]'::jsonb, '{"grade":"HB","pack":"12","type":"Graphite","brand":"Faber-Castell"}'::jsonb, NOW(), NOW());
