...
import { Bike, KeyRound, Lock, ArrowRight, AlertCircle, RefreshCw, Eye, EyeOff, CheckCircle2, ArrowLeft } from "lucide-react"
import { Input } from "@/ui/input"
import { Button } from "@/ui/button"
import { Label } from "@/ui/label"

export function RiderResetPasswordClient() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("/api/riderapp/auth/forgot-password/reset", {
        method: "POST",
      ...
      setTimeout(() => {
        router.push(data.loginUrl || "/riderapp/login?reset=1")
      }, 1500)
    } catch (err: any) {
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  required
                  disabled={loading}
                  className="pl-10 h-11 rounded-xl text-center text-base tracking-[0.3em] font-mono bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700"
                />
              </div>
            </div>
