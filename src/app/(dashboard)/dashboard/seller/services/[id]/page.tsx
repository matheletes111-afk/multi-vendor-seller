...
export default async function EditServicePage({
  ...
  if (!seller) {
    redirect("/dashboard/seller/services?error=seller_not_found")
  }

  // Get service and verify it belongs to the seller
  ...
  if (!service) {
    redirect("/dashboard/seller/services?error=service_not_found")
  }
