    ...
    <div className="p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1">Welcome back to your hotel partner panel.</p>
        </div>
      </div>
      
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {[
          { label: "Active Hotels", value: "0", icon: "🏢" },
      ...
      <div className="mt-12 bg-blue-50 border border-blue-100 p-8 rounded-[2.5rem] text-center">
        <h2 className="text-2xl font-bold text-blue-900">Partner Registration Complete!</h2>
        <p className="text-blue-700 mt-2 max-w-lg mx-auto">
