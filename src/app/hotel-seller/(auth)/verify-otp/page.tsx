...
const SEND_OTP_URL = "/api/hotel-seller/auth/send-otp"
const VERIFY_OTP_URL = "/api/hotel-seller/auth/verify-otp"

function HotelSellerVerifyOtpForm() {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gray-50/90 p-4">
        <div className="w-full max-w-[440px] rounded-3xl bg-white p-8 shadow-xl text-center">
          ...
          <Link href="/hotel-seller/login" className="mt-4 inline-block text-blue-600 hover:underline">Back to login</Link>
        </div>
      </div>
    )
  }
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50/90 p-4">
      <div className="w-full max-w-[440px] rounded-3xl bg-white p-8 shadow-xl">
        ...
        <p className="mt-6 text-center text-sm text-gray-600">
          <Link href="/hotel-seller/login" className="font-medium text-blue-600 hover:underline">Back to login</Link>
        </p>
      </div>
    </div>
  )
