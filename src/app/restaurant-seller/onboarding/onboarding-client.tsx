...
const RESTAURANT_SELLER_STEP_FILES: Record<number, string[]> = {
  2: ["profileImage", "busRegCert", "cityCouncilCert", "gstTinCert", "addressProof"],
  3: ["idFront", "idBack", "foodLicense", "selfie"],
  ...
  const handleNext = async (e: React.FormEvent) => {
    ...
    const currentStepFileKeys = RESTAURANT_SELLER_STEP_FILES[currentStep] || []
    ...
    try {
      ...
      const completedStepKeys = RESTAURANT_SELLER_STEP_FILES[currentStep] || []
      setPreviews((prev) => {
        const copy = { ...prev }
            ...
            {currentStep === 5 && (
              <form onSubmit={handleNext} className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div>
                  ...
                  <p className="text-slate-500 mt-2 text-sm">Where you want to receive restaurant earnings.</p>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="w-full h-11 sm:h-12 px-3.5 rounded-xl border border-slate-200 bg-white text-slate-800 font-medium focus:outline-none focus:ring-2 focus:ring-amber-500"
                    >
                  ...
                  {paymentOption === "Bank" ? (
                    ...
                    <div className="space-y-6 animate-in fade-in duration-300 p-6 rounded-2xl bg-gradient-to-br from-amber-50/60 to-orange-50/30 border border-amber-200/70">
