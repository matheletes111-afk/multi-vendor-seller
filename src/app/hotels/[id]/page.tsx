...
import { Star, MapPin, Building2, CheckCircle2, ChevronRight, User, Users, Coffee, ShieldAlert, ArrowLeft, MessageSquare, ZoomIn } from "lucide-react"
                      ...
                      <div className="flex flex-wrap gap-2 mt-2 pl-12">
                        {rImgs.map((img: string, idx: number) => (
                          <button
                            ...
                            className="group relative w-16 h-16 rounded-xl overflow-hidden border border-slate-200 shadow-xs shrink-0 bg-slate-50 hover:border-emerald-500 hover:shadow-md transition-all focus:outline-none ring-2 ring-transparent focus:ring-emerald-500 cursor-pointer"
                            title="Click to view large image"
                          >
                            <img src={img} alt="Review photo" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
                    ...
                    <div className="flex flex-wrap gap-2 mt-2">
                      {reviewPreviews.map((url, index) => (
                        <button
                          ...
                          className="group relative w-14 h-14 rounded-xl overflow-hidden border border-slate-200 shadow-xs shrink-0 bg-slate-50 hover:border-emerald-500 hover:shadow-md transition-all cursor-pointer"
                          title="Click to view large image"
                        >
