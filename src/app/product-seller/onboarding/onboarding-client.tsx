...
import { FileText, Image as ImageIcon, CheckCircle2, ChevronLeft, ChevronRight, Upload, Check, User, LogOut, Plus, X, Pencil, Camera, Crop, Eye } from "lucide-react"
        ...
        <div className="md:hidden bg-slate-900 text-white px-4 py-2.5 sticky top-0 z-20 shadow-md">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-bold text-purple-400 uppercase tracking-wider bg-slate-800 px-2 py-0.5 rounded-full border border-slate-700">
                Product
              </span>
            </div>
            <Button
        ...
        <div className="flex-1 bg-white p-4 sm:p-6 md:p-12 md:overflow-y-auto md:max-h-[850px] relative">
          ...
          <div className="max-w-2xl mx-auto">
              ...
              <form onSubmit={handleNext} className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="businessName" name="businessName" defaultValue={seller.businessInfo?.businessName || ""} required className="h-11 sm:h-12 rounded-xl focus:ring-purple-500" />
                  </div>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="businessRegNumber" name="businessRegNumber" defaultValue={seller.businessInfo?.businessRegNumber || ""} className="h-11 sm:h-12 rounded-xl" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2 pt-2">
                    ...
                    <div className="mt-2 p-4 sm:p-6 border-2 border-dashed rounded-2xl bg-purple-50/30 border-purple-100 transition-colors hover:bg-purple-50/50">
            ...
            {currentStep === 3 && (
              <form onSubmit={handleNext} className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="mb-8">
                  ...
                  <p className="text-slate-500 mt-2 text-sm">Mandatory KYC verification for security and fraud prevention.</p>
                </div>
                <div className="space-y-6">
                  <div className="space-y-2">
            ...
            {currentStep === 4 && (
              <form onSubmit={handleNext} className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="mb-8">
                  <h1 className="text-2xl sm:text-3xl font-bold text-slate-900">Payment & Payout Details</h1>
                  <p className="text-slate-500 mt-2 text-sm">Choose how you would like to receive payouts from your sales.</p>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={paymentOption} onValueChange={(val) => setPaymentOption(val)}>
                      <SelectTrigger id="paymentOption" className="h-11 sm:h-12 rounded-xl border-slate-200 bg-white">
                  ...
                  {paymentOption === "Bank" ? (
                    <div className="space-y-6 animate-in fade-in duration-300">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-2 p-4 sm:p-6 bg-slate-50 rounded-2xl border border-slate-100">
                          <Label htmlFor="bankPassbook" className="text-sm font-semibold mb-2 block">Bank Passbook / Cheque Copy (Optional)</Label>
                          <p className="text-xs text-slate-500 mb-3">Upload passbook front page or cancelled check</p>
                          <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                            <Input id="bankPassbook" name="bankPassbook" type="file" accept={ALLOWED_DOC_ACCEPT} onChange={(e) => handleFileChange(e, "bankPassbook")} className="h-11 sm:h-12 cursor-pointer file:cursor-pointer flex-1" />
                            <Button
                              type="button"
                              variant="outline"
                              size="sm"
                              onClick={() => setCameraTarget({ key: "bankPassbook", label: "Bank Passbook", facingMode: "environment", guideType: "document" })}
                              className="h-10 px-3.5 text-xs flex items-center justify-center gap-1.5 shrink-0 rounded-xl w-full sm:w-auto"
                              title="Take photo with camera"
                            >
                              <Camera className="w-4 h-4 text-purple-600" />
                        ...
                        <div className="space-y-2 p-4 sm:p-6 bg-slate-50 rounded-2xl border border-slate-100">
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                            <Input id="bankLetter" name="bankLetter" type="file" accept={ALLOWED_DOC_ACCEPT} onChange={(e) => handleFileChange(e, "bankLetter")} className="h-11 sm:h-12 cursor-pointer file:cursor-pointer flex-1" />
                            <Button
                              type="button"
                              variant="outline"
                              size="sm"
                    ...
                    <div className="space-y-6 animate-in fade-in duration-300 p-6 rounded-2xl bg-gradient-to-br from-purple-50/50 to-indigo-50/30 border border-purple-100">
                      <div className="flex items-center gap-3 pb-2 border-b border-purple-100/60">
            ...
            {currentStep === 5 && (
              <form onSubmit={handleNext} className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="mb-8">
                  <h1 className="text-2xl sm:text-3xl font-bold text-slate-900">Store Setup</h1>
                  <p className="text-slate-500 mt-2 text-sm">Tell us about your store and what you sell.</p>
                </div>
                <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                          ...
                          <Button 
                            ...
                            onClick={() => {
                              ...
                              setTempSuggestion({ name: "", description: "", image: null, imagePreview: "", icon: null, iconPreview: "" })
                      ...
                      <div className="p-4 bg-purple-50/20 border border-purple-100 rounded-2xl space-y-3">
                         <div className="flex items-center justify-between">
                            <span className="text-xs font-bold text-purple-900 flex items-center gap-1.5">
                              ...
                              Suggested Categories to be Created ({suggestionsList.length})
                            </span>
                            <span className="text-[10px] text-purple-500">Will be created upon onboarding</span>
                         </div>
            ...
            {currentStep === 6 && (
              <form onSubmit={handleNext} className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="mb-8">
                  ...
                  <p className="text-slate-500 mt-2 text-sm">Almost there! Please review and accept our terms.</p>
                </div>
                ...
                <div className="mt-8 sm:mt-12 flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-between gap-3 pt-6 border-t border-slate-100">
                  <Button type="button" variant="ghost" onClick={handleBack} disabled={saving} className="h-11 sm:h-12 px-8 rounded-full text-slate-500 hover:text-slate-900 w-full sm:w-auto"><ChevronLeft className="mr-2 h-4 w-4" /> Back</Button>
                  <Button type="submit" className="h-11 sm:h-12 px-10 rounded-full bg-green-600 hover:bg-green-700 text-white shadow-lg transition-all hover:scale-[1.02] active:scale-95 w-full sm:w-auto" disabled={saving || !Object.values(agreements).every(v => v)}>
