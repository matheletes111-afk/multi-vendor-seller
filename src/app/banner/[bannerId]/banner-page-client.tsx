...
export function BannerPageClient() {
  ...
  return (
    <div className="flex-1 min-w-0 overflow-x-hidden" style={{ background: "#fefefe" }}>
        {/* Banner hero - responsive heights and text */}
        <section className="relative w-full bg-muted overflow-hidden min-h-[35vh] sm:min-h-[42vh] md:min-h-[50vh] lg:min-h-[55vh]">
          <div className="relative w-full h-full min-h-[35vh] sm:min-h-[42vh] md:min-h-[50vh] lg:min-h-[55vh] overflow-hidden">
            <div className="absolute inset-0">
              <img
                ...
                fetchPriority="high"
              />
              <div className="absolute inset-0 flex items-center justify-center px-3 sm:px-4 md:px-6 py-6 drop-shadow-md">
        ...
        {/* Products - responsive container and grid */}
        ...
        {/* Services - same category as banner, responsive */}
        <section className="container mx-auto w-full max-w-7xl px-3 py-5 sm:px-4 sm:py-6 md:px-5 md:py-8 border-t border-slate-200/60">
          <div className="flex flex-wrap items-center gap-2 mb-4 sm:mb-6">
            ...
            <h2 className="text-base font-bold text-slate-800 sm:text-lg md:text-xl">
              {banner.categoryId ? "Services in this category" : "Services"}
            </h2>
            <span className="rounded-full bg-slate-200 px-2.5 py-0.5 text-xs font-medium text-slate-600">
                  ...
                  <Card className="h-full overflow-hidden border border-slate-200 bg-white shadow-sm transition-shadow hover:shadow-md">
                    ...
                    <CardContent className="p-3 sm:p-4 md:p-6">
                      ...
                      <p className="mt-1 text-xs text-muted-foreground">
                        <span className="rounded border border-slate-200 px-1.5 py-0.5 text-[10px] sm:text-xs">{service.category.name}</span>
                      </p>
