...
const kind: CustomerOrderKind = "product"

/** GET /mobileapi/customer/orders/products/details/[id] — product order details for current customer. Auth: Bearer token. */
export async function GET(
  ...
  try {
    ...
    console.error("Mobile product order details error:", error)
