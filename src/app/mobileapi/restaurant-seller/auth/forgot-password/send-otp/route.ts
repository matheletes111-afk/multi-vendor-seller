...
/** POST /mobileapi/restaurant-seller/auth/forgot-password/send-otp */
export async function POST(request: Request): Promise<NextResponse<ApiResponse>> {
  try {
    ...
    const resetLink = `${baseUrl}/restaurant-seller/reset-password?${identifierParam}`
    ...
    console.error("Mobile restaurant-seller forgot-password send-otp error:", error)
