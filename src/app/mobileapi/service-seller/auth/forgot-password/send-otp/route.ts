...
/** POST /mobileapi/service-seller/auth/forgot-password/send-otp */
export async function POST(request: Request): Promise<NextResponse<ApiResponse>> {
  try {
    ...
    const resetLink = `${baseUrl}/service-seller/reset-password?email=${encodeURIComponent(email)}`
    ...
    console.error("Mobile service-seller forgot-password send-otp error:", error)
