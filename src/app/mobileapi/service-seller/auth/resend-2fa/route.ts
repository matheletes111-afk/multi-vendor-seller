...
/** POST /mobileapi/service-seller/auth/resend-2fa — Resend 2FA OTP for Service Seller mobile login */
export async function POST(request: Request) {
  try {
    ...
    console.error("Mobile service-seller 2FA resend error:", error)
    return NextResponse.json(
