...
/** POST /mobileapi/product-seller/auth/verify-2fa — Verify 2FA OTP for Product Seller mobile login */
export async function POST(request: Request) {
  try {
    ...
    console.error("Mobile product-seller 2FA verification error:", error)
    return NextResponse.json(
