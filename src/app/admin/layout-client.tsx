...
import { LogOut, User, LayoutDashboard, Users, CreditCard, FolderTree, Briefcase, Megaphone, Menu, BadgeDollarSign, ImageIcon, ShoppingCart, Star, Building2, Calendar, Package, Utensils, Ticket, LifeBuoy, Bike } from "lucide-react"
    ...
    <div className="space-y-4">
      <div>
        ...
        <div className="space-y-0.5">
          ...
          <NavItem href="/admin/coupons" label="Coupons" icon={<Ticket className="h-4 w-4" />} />
        </div>
      </div>
    ...
    <div className="flex min-h-screen">
      <Sidebar className="hidden md:block">
        ...
        <div className="border-t p-4">
          <Button type="button" variant="outline" className="w-full" onClick={() => signOut({ redirect: false }).then(() => { window.location.href = "/" })}>
            Logout
          </Button>
        </div>
      </Sidebar>
