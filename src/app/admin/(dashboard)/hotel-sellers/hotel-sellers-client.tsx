...
export function HotelSellersClient() {
  ...
  const pathname = usePathname() || "/admin/hotel-sellers"
            ...
            <Table>
              <TableHeader className="bg-slate-50/80 dark:bg-slate-950/50">
                <TableRow className="border-slate-100 dark:border-slate-800">
                  <TableHead className="py-4 pl-6 min-w-[220px]">Hotel / Property</TableHead>
                        ...
                        >
                          ...
                          <TableCell className="py-4 pl-6 font-medium min-w-[220px]">
                            <div className="flex items-start gap-3">
                              <Avatar className="h-10 w-10 rounded-2xl border border-slate-200 dark:border-slate-800 shrink-0 mt-0.5">
                                ...
                                <AvatarFallback className="rounded-2xl font-bold bg-emerald-50 text-emerald-600 dark:bg-emerald-950/40 dark:text-emerald-400 text-xs">
                                  {initials}
                                </AvatarFallback>
                              </Avatar>
                              <div className="space-y-1 min-w-0">
                                <div className="min-w-0">
                                  <Link
                                    href={`/admin/hotel-sellers/${seller.id}?returnUrl=${encodeURIComponent(currentListUrl)}`}
                                    className="font-bold text-sm text-slate-900 dark:text-slate-100 hover:text-emerald-600 dark:hover:text-emerald-400 hover:underline inline-flex items-center gap-1 leading-tight group truncate max-w-[190px]"
                                    title="View full hotel seller profile & details"
                                  >
                                ...
                                return (
                                  <div className="inline-flex items-center gap-1.5 whitespace-nowrap">
                                    <Badge
                                      ...
                                      title={`Default hotel base commission set by admin: ${baseRate}% (Click to assign custom rate)`}
                                    >
                          ...
                          <TableCell className="text-right pr-6 min-w-[130px]">
                            <div className="flex justify-end items-center gap-1.5">
                              ...
                              <Link
                                href={`/admin/hotel-sellers/${seller.id}/analytics?returnUrl=${encodeURIComponent(currentListUrl)}`}
                ...
                <>
                  ...
                  <div className="p-3 bg-slate-50 dark:bg-slate-950/60 rounded-2xl border border-slate-100 dark:border-slate-800/80 space-y-1">
                    <p className="text-[11px] text-muted-foreground">
                      💡 Leave empty to use admin default hotel base commission (<strong className="text-foreground">{currentBaseRate}%</strong>).
                    </p>
                    <p className="text-[11px] text-muted-foreground">
