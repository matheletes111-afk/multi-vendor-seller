  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <Input id={discountName} name={discountName} type="number" step="0.01" min="0" placeholder="0.00" defaultValue={defaultDiscount} onChange={(e) => setDiscount(parseFloat(e.target.value) || 0)} />
      </div>
