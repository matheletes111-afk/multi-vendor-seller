...
const SERVICE_SELLER_STEP_FILES: Record<number, string[]> = {
  ...
  const handleNext = async (e: React.FormEvent) => {
    ...
    const currentStepFileKeys = SERVICE_SELLER_STEP_FILES[currentStep] || []
    ...
    try {
      ...
      const completedStepKeys = SERVICE_SELLER_STEP_FILES[currentStep] || []
      setPreviews((prev) => {
        const copy = { ...prev }
            ...
            {currentStep === 4 && (
              <form onSubmit={handleNext} className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="mb-8">
                  ...
                  <p className="text-slate-500 mt-2 text-sm">Choose how you would like to securely receive payments for your services.</p>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-slate-500">
                      Select Bank for direct transfer, or Orange Money / AfriMoney for instant mobile wallet payouts.
                    </p>
                  </div>
