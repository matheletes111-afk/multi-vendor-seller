...
export async function PATCH(
  ...
  try {
    // Use any cast to bypass stale Prisma types until language server catches up
    ...
    console.error("Failed to update seller commission:", error)
    return NextResponse.json({ error: "Failed to update seller commission" }, { status: 500 })
  }
}
