...
/** POST /api/admin/auth/forgot-password/reset — Body: { email, otp, newPassword } */
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json({ message: "Password reset successful.", loginUrl: "/admin/login?reset=1" }, { status: 200 })
  } catch (error) {
