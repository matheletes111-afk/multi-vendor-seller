...
/** POST /api/service-seller/auth/verify-otp — Body: { email, otp } */
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json({ message: "Email verified.", loginUrl: "/service-seller/login?verified=1" }, { status: 200 })
  } catch (error) {
