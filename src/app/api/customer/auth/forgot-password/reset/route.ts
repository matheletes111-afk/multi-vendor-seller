...
/** POST /api/customer/auth/forgot-password/reset — Body: { email, phone, phoneCountryCode, otp, newPassword } */
export async function POST(request: Request) {
  try {
    ...
    console.error("Customer forgot-password reset error:", error)
