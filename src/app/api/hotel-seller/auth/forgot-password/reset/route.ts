...
/** POST /api/hotel-seller/auth/forgot-password/reset — Body: { email, phone, phoneCountryCode, otp, newPassword } */
export async function POST(request: Request) {
  try {
    ...
    console.error("Hotel seller forgot-password reset error:", error)
