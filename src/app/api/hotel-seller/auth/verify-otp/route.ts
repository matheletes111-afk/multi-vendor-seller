...
/** POST /api/hotel-seller/auth/verify-otp — Body: { email, phone, otp, phoneCountryCode } */
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json({ message: "Account successfully verified.", loginUrl: "/hotel-seller/login?verified=1" }, { status: 200 })
  } catch (error) {
